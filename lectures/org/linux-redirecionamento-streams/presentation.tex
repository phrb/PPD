...
\label{sec:org38a3adb}
\begin{frame}[label={sec:orgb027a06}]{Streams Padrão em Processos POSIX}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge3f85ff},fragile]{Usando Arquivos de \emph{Log}: Redirecionamento de Saída e Erros}
 \begin{figure}
...
\begin{frame}[label={sec:org780b681},fragile]{Monitorando o Linux: Redirecionamento de Saída}
...
\begin{frame}[label={sec:orge82b88c},fragile]{Monitorando o Linux: Redirecionamento de Entrada}
...
\begin{frame}[label={sec:org124dc12},fragile]{Exercício: Script de Redirecionamento}
...
\begin{frame}[label={sec:org6522222},fragile]{Exercício: Script de Redirecionamento}
 \begin{figure}
\begin{minipage}{\textwidth}
\begin{minted}[]{bash}
#!/usr/bin/bash
...
\begin{frame}[label={sec:orgd0be742},fragile]{Chamada \emph{pipe}}
