...
\section{Introdução}
\label{sec:orgd0c8a6f}
\begin{frame}[label={sec:org519250f}]{Conteúdo e Objetivos de Aprendizagem}
\begin{columns}
...
\begin{frame}[label={sec:orgdc714ed}]{Registrando Mensagens e Monitorando Sistemas}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcfd4470},t,fragile]{Registrando Mensagens e Monitorando Sistemas}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org804531f}
\begin{frame}[label={sec:org03ed6e7}]{Streams Padrão em Processos POSIX}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga7d89e4},fragile]{Usando Arquivos de \emph{Log}: Redirecionamento de Saída e Erros}
 \begin{figure}
...
\begin{frame}[label={sec:orgdd5fb39},fragile]{Monitorando o Linux: Redirecionamento de Saída}
...
\begin{frame}[label={sec:orgc87c275},fragile]{Monitorando o Linux: Redirecionamento de Entrada}
...
\begin{frame}[label={sec:orge021b22},fragile]{Exercício: Script de Redirecionamento}
...
\begin{frame}[label={sec:org7a497a2},fragile]{Exercício: Script de Redirecionamento}
 \begin{figure}
\begin{minipage}{\textwidth}
\begin{minted}[]{bash}
#!/usr/bin/bash
...
\begin{frame}[label={sec:org7122e23},fragile]{Síntese: Redirecionamento de Streams em \emph{bash}}
\begin{figure}
\small
...
\begin{frame}[label={sec:orgc778f0e}]{Conectando Streams de Entrada/Saída}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{block}{Problemas}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgaa7d7e7},t,fragile]{Conectando Streams de Entrada/Saída}
\begin{columns}
\begin{column}{0.5\columnwidth}
...
\label{sec:org0ad5b25}
\begin{frame}[label={sec:org00d5cbe}]{Descritores de Arquivo em Processos POSIX}
\begin{center}
...
\begin{frame}[label={sec:orgbdede6f},fragile]{Algumas Chamadas POSIX}
 \begin{figure}
...
\begin{frame}[label={sec:orgb2485c5},fragile]{Chamadas \emph{dup} e \emph{dup2}}
...
\begin{frame}[label={sec:org0d8e776},fragile]{Chamada \emph{pipe}}
...
\begin{frame}[label={sec:org41b232c},fragile]{Exercício: Redirecionamento em C}
 \begin{columns}
\begin{column}{0.5\columnwidth}
...
\begin{frame}[label={sec:org86b8f9a},fragile]{Síntese: Duplicando Descritores de Arquivo}
 \begin{columns}
\begin{column}{0.5\columnwidth}
